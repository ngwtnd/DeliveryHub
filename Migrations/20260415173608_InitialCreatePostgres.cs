        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDelivering = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    CitizenIdFrontImageUrl = table.Column<string>(type: "text", nullable: true),
                    CitizenIdBackImageUrl = table.Column<string>(type: "text", nullable: true),
                    DriverLicenseImageUrl = table.Column<string>(type: "text", nullable: true),
                    VehicleType = table.Column<string>(type: "text", nullable: true),
                    HasOneStarReview = table.Column<bool>(type: "boolean", nullable: false),
                    ShipperCode = table.Column<string>(type: "text", nullable: true),
                    ShopAvatarUrl = table.Column<string>(type: "text", nullable: true),
                    PartnerCode = table.Column<string>(type: "text", nullable: true),
                    ManagedStoreId = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedMinutesPerKm = table.Column<int>(type: "integer", nullable: false),
                    BaseFee = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    FeePerKm = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    ExtraFeePerKg = table.Column<decimal>(type: "numeric(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppliesToShipping = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipperIncome = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    BatchOrderId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipperId = table.Column<string>(type: "text", nullable: true),
                    StoreId = table.Column<int>(type: "integer", nullable: true),
                    RatingMenu = table.Column<int>(type: "integer", nullable: false),
                    RatingShipper = table.Column<int>(type: "integer", nullable: false),
                    Comment = table.Column<string>(type: "text", nullable: true),
                    CommentForShipper = table.Column<string>(type: "text", nullable: true),
                    Type = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
